我是石家庄铁道大学2019级（大三）软件工程系的学生，希望可以在贵公司参加实习工作，请您过目我的简历。

**个人简介：**

本科软件工程专业，熟悉Java语言。能熟练使用当前主流JavaWeb框架（SSM、SpringBoot等）,掌握Python、C/C++。有前瞻性、自驱性独立学习习惯。曾参与实际工程项目并取得一定成果和收获，对大数据和人工智能有一定的了解和应用。沟通表达能力强，曾担任学院主持人工作。有一定的英语基础（CET6 510），可以独立完成英文文献文档等的阅读。
